...
//   useEffect(() => {
//     // console.log('selectedCustomer', selectedCustomer?.documents);
//     if (selectedCustomer) {
//       const objData = [
//         {key: 'SCP No.', value: userByScpNumber?.scpDetail?.scpNo},
//         {
...
//     await dispatch(documentHandler(selectedCustomer?.documents[0].id));
//     // await dispatch(documentHandler(selectedCustomer?.documents[1].id));
//     // dispatch(documentHandler(selectedCustomer?.documents[2].id));
//     return;
//   };
